            ...
            <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        th({ children }) {
                            return <th className="px-3 py-2 text-left text-ls font-medium text-gray-500 uppercase tracking-wider">{children}</th>;
                        },
                        td({ children }) {
...
function CodeBlock({ code, language }) {
    ...
    return <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
        <div className="flex items-center justify-center px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        <SyntaxHighlighter
           language={language}
           style={oneLight}
           customStyle={{fontSize:"14px",margin:0,padding:'1rem',background:'transparent'}}
        >
            {code}
        </SyntaxHighlighter>
    </div>
