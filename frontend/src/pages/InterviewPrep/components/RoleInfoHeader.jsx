    ...
    <div className='bg-white relative'>
        <div className='container mx-auto px-10 md:px-0'>
           ...
           <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center overflow-hidden absolute top-0 right-0">
                <div className="w-20 h-20 bg-lime-400 blur-[65px] animate-blob1" />
                <div className="w-20 h-20 bg-teal-400 blur-[65px] animate-blob2" />
                <div className="w-20 h-20 bg-cyan-300 blur-[55px] animate-blob3" />
                <div className="w-20 h-20 bg-fuchsia-200 blur-[55px] animate-blob1" />
            </div>
        </div>
    </div>
  )
