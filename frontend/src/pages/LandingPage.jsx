...
import Modal from '../components/Modal'; // or correct path
  ...
  return (
    <>
      <div className='w-full min-h-full bg-[#FFFCEF]'>
        <div className='w-full min-h-full bg-amber-200/20 bg-blur-[65px] absolute top-0 left-0'>
      ...
      <div className='w-full min-h-full relative z-10'>
        <div>
          <section className='flex items-center justify-center mt-[550px]'>
            <img src={hero_IMG}
              alt="hero_IMG"
